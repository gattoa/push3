# Push — Brand Guidelines

> Visual identity, color semantics, shape language, motion, and mood for the Push brand.
> Source of truth for all design and implementation decisions.
> Last updated: 2026-03-24
>
> **Companion files:** `tokens.css` (CSS variables), `/design-system` (live preview)

---

## Mood & Positioning

Push is for athletes — but it's approachable, welcoming, and transformative. Users should feel energized during workouts, calm when reviewing progress, celebrated when hitting milestones, and gently prompted when it's time to check in.

We focus on natural bodybuilding and positive growth through movement. The app should work great in the gym to track workouts, and at home to explore progress. Not cliche, but familiar, contemporary, clean, and intuitive.

**Visual direction:** Vibrant Momentum — expressive, rewarding, alive. Premium without being cold. Inspired by Nike Run Club's balance of minimal and motivating, but with Push's own identity.
...
**How to apply:** Use these guidelines when building any new UI in Push. The design system preview page at `/design-system` is the live reference. `tokens.css` contains the CSS variables that implement these decisions.
